...
<div class="container mt-5 mb-5">
    <div class="card" style="background-image:url(@yield('bg')); border-color:black;background-size:cover; height:500px" id="layout">
        <div class="row mt-5 ml-5 mr-5">
            <div class="col col-4">
                <div id="c" class="card" style="height:110px; border-color:black" >
                    @if ($loop->iteration==1)
                ...
                <div id="c" class="card mt-3" style="height:110px; border-color:black" >
                    <div hidden>
                    {{ $hasil=$hasil+1}}
                        </div>
                        @foreach ($album as $item)
            ...
            <div class="col col-8 mb-3">
                <div id="c" class="card" style="height:230px; border-color:black" >
                        <div hidden>
                        {{ $hasil=$hasil+1}}
                            </div>
                            @foreach ($album as $item)
        ...
        <div class="row ml-5 mr-5">
            <div class="col">
                <div id="c" class="card" style="height:120px; border-color:black" >
                    <div hidden>
                        {{ $hasil=$hasil+1}}
                            </div>
                            @foreach ($album as $item)
