    ...
    <div class="row">
        <div class="col text-center">
            ...
            <img src="{{ asset('assets/images/'.$item->image) }}" class="mt-3 mb-3 img-thumbnail">
                ...
                <hr>
                <form class="form-row"  method="post" action="{{url('changePassword')}}">
                    @csrf
                    <div class="col">
                ...
                <hr>
                <form class="form-row"  method="post" action="{{url('changeName')}}">
                    @csrf
                    <div class="col">
                        <div class="form-group">
                    ...
                    <div class="col">
                        <button type="submit" class="btn btn-success mt-4 float-right mr-5">Change</button>
                    </div>
                </form>
                @endforeach
        </div>
