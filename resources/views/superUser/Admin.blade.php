...
<div class="card-header text-center">
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <form class="form-inline my-2 my-lg-0" method="get" action="{{ url('superUser/cari') }}">
                    @csrf
...
<table class="table table-bordered">
        ...
        <tbody>
            ...
            <td>
                ...
                <form action="{{ url('hapusAdmin') }}" class="d-inline"  method="post">
                    @method('delete')
                    @csrf
                    <input type="hidden" name="id" value="{{ $item->id }}">
                ...
                <a target="d-blank" href="https://wa.me/{{$item->phone}}?text=Login+pada+https://album.spydercode.site+dengan+%3A%0D%0Ausername+%3A+{{ $item->name }}%0D%0Apassword+%3A+{{ session('passAdmin') }}" class="btn btn-success d-inline">WhatsApp</a>
            </td>
            </tr>
            @endforeach
        </tbody>
