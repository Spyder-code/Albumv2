...
<body>
    <div id="app">
        ...
        <div id="wrapper">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('superUser/admin') }}" ><i class="fas fa-user-tie"></i>
                <span>Admin</span>
                </a>
            </li>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('superUser/customer') }}" ><i class="fas fa-users"></i>
                <span>Customer</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url('superUser/tasks') }}" ><i class="fas fa-tasks"></i>
                <span>Tasks</span>
                </a>
            </li>
